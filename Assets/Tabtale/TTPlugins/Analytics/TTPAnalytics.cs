...
namespace Tabtale.TTPlugins
{
    ...
    public class TTPAnalytics
    {
        ...
        public static event Action<String> OnRecievedFirebaseInstallationIdEvent;
        ...
        [Preserve]
        static void LogEventToFirebase(string eventName, Dictionary<string, object> additionalParams)
        {
            if (Impl != null)
            {
                IDictionary<string, object> eventParams = new Dictionary<string, object>();
        ...
        class AnalyticsDelegate : MonoBehaviour
        {
            ...
            private class OnReceivedInstallationIdMessage
            {
                public string installationId = "NA";
            }
            ...
            public void OnReceivedInstallationId(string message)
            {
                Debug.Log("AnalyticsDelegate::OnReceivedInstallationId: " + message);
                if(message != null)
                {
                    var receivedInstallationIdMessage = JsonUtility.FromJson<OnReceivedInstallationIdMessage>(message);
                    if(receivedInstallationIdMessage != null && OnRecievedFirebaseInstallationIdEvent != null)
                    {
                        OnRecievedFirebaseInstallationIdEvent.Invoke(receivedInstallationIdMessage.installationId);
                    }
                }
            }
        }
